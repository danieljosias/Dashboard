...
export default function Privacidade() {
 return (
   <div className="container-privacidade">
            <h2 className="title-privacidade">Política Privacidade</h2>
            <div className="texto-privacidade">
                <p>A sua privacidade é importante para nós. É política do React Dashboard respeitar a sua privacidade em
                    relação a qualquer informação sua que possamos coletar no site <a href="http://www.domínio.com">React Dashboard</a>, e outros sites que possuímos e operamos.</p>
